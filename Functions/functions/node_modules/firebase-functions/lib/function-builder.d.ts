...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any | Promise<any>) => import("./cloud-functions").TriggerAnnotated & ((req: express.Request<import("express-serve-static-core").ParamsDictionary>, resp: express.Response<any>) => void) & import("./cloud-functions").Runnable<any>;
    };
    get database(): {
        /**
