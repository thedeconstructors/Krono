...
public class PlansListAdapter extends RecyclerView.Adapter<PlansListAdapter.ViewHolder>
{
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.menu0_listitem, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public ViewHolder(@NonNull View itemView)
        {
            ...
            titleText = (TextView) m_view.findViewById(R.id.title_text);
            descriptionText = (TextView) m_view.findViewById(R.id.description_text);
        }
    }
}
